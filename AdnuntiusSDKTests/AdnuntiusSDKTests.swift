...
class AdnuntiusSDKTests: XCTestCase {
    ...
    func testToJson() throws {
        ...
        //print(script)
        let expected = "<html> <head><script type=\"text/javascript\" src=\"https://cdn.adnuntius.com/adn.js\" async></script><style>body {margin-top: 0px;margin-left: 0px;margin-bottom: 0px;margin-right: 0px;}</style> </head> <body><div id=\"adn-some auId\" style=\"display:none\"></div><script type=\"text/javascript\">window.adn = window.adn || {}; adn.calls = adn.calls || [];adn.calls.push(function() {adn.request({onPageLoad: adnSdkShim.onPageLoad,onImpressionResponse: adnSdkShim.onImpressionResponse,onVisible: adnSdkShim.onVisible,onViewable: adnSdkShim.onViewable,onRestyle: adnSdkShim.onRestyle,adUnits: [{auId: 'some auId', auH: '200', auW: '100', kv: {'car': ['holden', 'ford'], 'sport': ['soccer']}, c: ['cat1', 'cat2']}],userId: 'my global user id', sessionId: 'my session id', useCookies: false, consentString: 'some consent string', gdpr: '1'});});</script> </body></html>"
